...
*/
ob_start();
$API_KEY = '1528663494:AAFDuf5vUzGkgkRPPbdVnwmpN3kw1Qr-bCQ';
$bot_ = "k_8bot";
 ...
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
     ...
     ['text'=>"اضفني الى مجموعتك ♣️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
    	...
    	[
     ['text'=>"مراسلة المطور 🚶", 'url'=>"t.me/iadham_17"]
     ],
	   [
    ...
    ['text'=>"Add me to your Gp ♣️️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
     ...
     [
     ['text'=>"support 💡", 'url'=>"t.me/adham_17"]
     ],
    ]
    ])
    ]);
...
sendaction($chat_id, typing);
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	  [
	  ['text'=>"الصور",'url'=>"http://telegram.me/adham_ch"],['text'=> "$photo1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"الروابط",'url'=>"http://telegram.me/adham_ch"],['text'=> "$link1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"الاغاني",'url'=>"http://telegram.me/adham_ch"],['text'=> "$audio1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"البصمات",'url'=>"http://telegram.me/adham_ch"],['text'=> "$voice1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"الفيديو",'url'=>"http://telegram.me/adham_ch"],['text'=> "$video1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"الملصقات",'url'=>"http://telegram.me/adham_ch"],['text'=> "$sticker1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
   [
	  ['text'=>"التوجيه",'url'=>"http://telegram.me/adham_ch"],['text'=> "$fwd1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"المحادثة",'url'=>"http://telegram.me/adham_ch"],['text'=> "$text1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"الالعاب",'url'=>"http://telegram.me/adham_ch"],['text'=> "$game1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"الملفات",'url'=>"http://telegram.me/adham_ch"],['text'=> "$doc1" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  [
	  ['text'=>"التثبيت",'url'=>"http://telegram.me/adham_ch"],['text'=> "$pin1" ,'url'=>"http://telegram.me/adham_ch"]
	  ]
   ]
   ])
   ]);
...
sendaction($chat_id, 'typing');
	bot('KickChatMember',[
    'chat_id'=>$chat_id, // by @adham_17 = adham
    'user_id'=>$re_id
      ]);
bot('sendmessage',[
	'chat_id'=>$chat_id,
...
*Please now send new  welcome* 🌐", 
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	  [
	  ['text'=> "تالع 💡" ,'url'=>"http://telegram.me/adham_ch"]
	  ],
	  	 [
...
sendaction($chat_id, typing);
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
 	 [
	  ['text'=>"تابع 🌐" ,'url'=>"http://telegram.me/adham_ch"]
	  ]
   ]
   ])
   ]);
...
الميديا المفتوحة == ✅ ",
       ...
       [
      	...
      	['text'=>"all ~» $text12",'callback_data'=>"all"],	 ['text'=>"المحادثة ~» $text12",'callback_data'=>"all"]
   	 	 ...
   	 	 [
     		['text'=>"العودة 🔙 Back",'callback_data'=>"bagt"]
    	  ]		
       ]
       ])
       ]);   
